...
from nerfstudio.models.papr_model import PAPRModel, PAPRModelConfig
    ...
    def __init__(
        ...
        if world_size > 1:
            self._model = typing.cast(
                PAPRModel, DDP(self._model, device_ids=[local_rank], find_unused_parameters=True)
            )
